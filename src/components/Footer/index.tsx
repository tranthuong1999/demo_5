...
import { svg_facebook } from '../../assets/icon_facbook';
import { svg_insta } from '../../assets/icon_insta';
import { svg_linkin } from '../../assets/icon_linkin';
import { svg_you } from '../../assets/icon_you';
import { svg_camera } from '../../assets/icon_camera';
import { svg_circal } from '../../assets/icon_circal';
import { svg_human } from '../../assets/icon_human';
const FooterPage = () => {
    ...
    return (
        <div className={classNames("footer-page", (isMobile || isTabnet) ? "footer-page-small" : "")}>
            ...
            <div className={classNames('block-2', isMobile ? 'block-2-mobile' : "")}>
                ...
                <div className={classNames('block-2-right', isMobile ? 'block-2-right_mobile' : "")}>
                    <div className='block-2_right_child'>
                        <div className='icon'>{svg_insta()} </div>
                        <div className='icon'>{svg_facebook()} </div>
                        <div className='icon'>{svg_linkin()} </div>
                        <div className='icon'>{svg_you()} </div>
                        <div className='icon'>{svg_camera()} </div>
                    </div>
                    <div className='block-2_right_child_2'>
                        <div className='check'>
                            <div className='icon'>{svg_circal()}</div>
                            <span>English</span>
                        </div>
                        <p className='check'> US$ USD</p>
                        <div className='icon icon_human'>{svg_human()} </div>
                    </div>
                </div>
