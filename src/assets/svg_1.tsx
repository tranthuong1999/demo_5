    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
            ...
            <g style={{isolation: "isolate"}}>
                ...
                <path d="M15 23l5 7h8l-6-11-7 4zM11.7 8.3a14.7 14.7 0 00-.2 8.9c1.5 4.1 5.1 5 7.9 1.7a2.4 2.4 0 00.7-2.4c-1.1-3.2-4.3-2.2-8.4-8.2zM39 30l11-20 5 3-9 17h-7zm-9 0h7l-1-12-3-8-3 8v12z" style={{mixBlendMode: "darken"}} fill="#a1f4c0" id="flah"/>
                <g id="stroke">
